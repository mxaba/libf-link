...
#    Updated: 2018/06/13 08:48:02 by mxaba            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC 	= ft_memchr.c ft_putnbr_fd.c ft_striter.c ft_strnew.c ft_atoi.c \
	  		ft_memcmp.c ft_putstr.c ft_striteri.c ft_strnstr.c ft_bzero.c \
			...
			ft_memmove.c ft_strchr.c ft_strlen.c ft_strstr.c ft_isascii.c \
			ft_memset.c ft_strclr.c ft_strmap.c ft_strsub.c ft_isdigit.c \
			ft_putchar.c ft_strcmp.c ft_strmapi.c ft_strtrim.c ft_isprint.c \
			ft_putchar_fd.c ft_strcpy.c ft_strncat.c ft_tolower.c ft_itoa.c \
			ft_putendl.c ft_strdel.c ft_strncmp.c ft_toupper.c ft_memalloc.c \
			ft_putendl_fd.c ft_strdup.c ft_strncpy.c ft_memccpy.c ft_putnbr.c \
			ft_strequ.c ft_strnequ.c ft_strrev.c \
...
OBJ 	= ft_memchr.o ft_putnbr_fd.o ft_striter.o ft_strnew.o ft_atoi.o \
			...
			ft_strequ.o ft_strnequ.o ft_strrev.o \
